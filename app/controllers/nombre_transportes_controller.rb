class NombreTransportesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @nombre_transporte.save
        format.html { redirect_to @nombre_transporte, notice: 'Nombre transporte was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @nombre_transporte.update(nombre_transporte_params)
        format.html { redirect_to @nombre_transporte, notice: 'Nombre transporte was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to nombre_transportes_url, notice: 'Nombre transporte was successfully destroyed.' }
