class TipoLugarsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tipo_lugar.save
        format.html { redirect_to @tipo_lugar, notice: 'Tipo lugar was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @tipo_lugar.update(tipo_lugar_params)
        format.html { redirect_to @tipo_lugar, notice: 'Tipo lugar was successfully updated.' }
  ...
  def destroy
    @tipo_lugar.destroy
    respond_to do |format|
      format.html { redirect_to tipo_lugars_url, notice: 'Tipo lugar was successfully destroyed.' }
